    ...
    return (
        ...
        <div className="carditem miditems">
            <div className="leftside px-sm-3 d-flex flex-column gap-sm-2 gap-1">
                ...
                <div className="prich d-flex align-items-center gap-2">₹{amount} <span className={`amountImg ${isHighlightAmountImg ? 'd-block' : 'd-none'} ${isHighlightAmountText ? 'text-theme3 active' : 'text-theme4'}`}> {gainLossAmount}%</span></div>
            </div>
        </div>
        </>
    )
